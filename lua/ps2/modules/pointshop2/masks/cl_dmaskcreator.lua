...
function PANEL:Init( )
	self:addSectionTitle( "Mask Selection" )
	...
	self.materialPanel:SetMaterial( "ps2_masks/gaben" )
	local frame = self
	function self.materialPanel:OnMousePressed( )
		--Open model selector
		local window = vgui.Create( "DMaterialMaskSelector" )
		window:Center( )
		window:MakePopup( )
		window:DoModal( )
	...
	self.manualEntry:SetText( "ps2_masks/gaben" )
...
vgui.Register( "DMaskCreator", PANEL, "DItemCreator" )
